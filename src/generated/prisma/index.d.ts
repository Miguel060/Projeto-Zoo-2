...
export namespace Prisma {
  ...
  */
  ...
  export type AnimalOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "nome" | "especie" | "descricao" | "imagemUrl", ExtArgs["result"]["animal"]>
  ...
  interface AnimalFieldRefs {
    ...
    readonly imagemUrl: FieldRef<"Animal", 'String'>
  }
  ...
  export type AnimalWhereInput = {
    ...
    imagemUrl?: StringNullableFilter<"Animal"> | string | null
  }
  ...
  export type AnimalScalarWhereWithAggregatesInput = {
    ...
    imagemUrl?: StringNullableWithAggregatesFilter<"Animal"> | string | null
  }
